...
class ChessApp(tk.Frame):
    Brown_Pawn_Image =Image.open("iloveimg-resized/bp2.png")
    Brown_Horse_Image = Image.open("iloveimg-resized/bn2.png")
    Brown_Knight_Image =Image.open("iloveimg-resized/bb2.png")
    Brown_Tower_Image = Image.open("iloveimg-resized/br2.png")
    Brown_King_Image =Image.open("iloveimg-resized/bk2.png")
    Brown_Queen_Image = Image.open("iloveimg-resized/bq2.png")
    Gray_Pawn_Image =Image.open("iloveimg-resized/wp2.png")
    Gray_Horse_Image = Image.open("iloveimg-resized/wn2.png")
    Gray_Knight_Image =Image.open("iloveimg-resized/wb2.png")
    Gray_Tower_Image = Image.open("iloveimg-resized/wr2.png")
    Gray_King_Image =Image.open("iloveimg-resized/wk2.png")
    Gray_Queen_Image = Image.open("iloveimg-resized/wq2.png")
...
def EndTurn(self, Square):
    if self.color_turn == 1:
        ...
        self.targetedgray = self.CheckPlayerMoves(self.BrownPiecesAlive)
        print(f"Black player Possible Moves: {sorted(self.targetedgray)}")
        checkmate = self.CheckmateCheck(self.BrownPiecesAlive, self.targetedgray)
        if checkmate:
        ...
        self.targetedbrown = self.CheckPlayerMoves(self.GrayPiecesAlive)
        print(f"Gold Player Possible Moves: {sorted(self.targetedbrown)}")
        checkmate = self.CheckmateCheck(self.GrayPiecesAlive, self.targetedbrown)
        if checkmate:
